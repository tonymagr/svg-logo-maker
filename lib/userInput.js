...
async function getInput () {
    ...
    .prompt ([
        ...
        {
            // Input text color, name or valid 3 or 6 digit hex number
            type: 'input',
        ...
        {
            // Input SVG shape, circle, triangle, or square
            type: 'list',
        ...
        {
            // Input shape color, name or valid 3 or 6 digit hex number
            type: 'input',
