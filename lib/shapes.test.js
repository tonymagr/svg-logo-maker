  ...
  // "render": Wrapper function for class instance, needed for Jest "expect" operator.
  // Inputted shape determines shape class
  ...
  describe('Circle', () => {
    describe('svgContent', () => {
      ...
      // Perform test. Compare to shapeConstants in required file to keep code clean and modular
